...
// Enter GPU kernel code body
  ...
  if ((i < ds) && (j < ds)){
    ...
    for (int k = 0; k < ds; k++){
      ...
      temp1 += A[k*ds+j+1] * B[i*ds+k];   // dot product of row and column
    }
...
grid dimesion 256 128
<BX=8,BY=8>: Trial 0: GFLOPS: 74.74
<BX=8,BY=8>: Trial 1: GFLOPS: 74.74
<BX=8,BY=8>: Trial 2: GFLOPS: 74.74
<BX=8,BY=8>: Trial 3: GFLOPS: 74.75
<BX=8,BY=8>: Trial 4: GFLOPS: 74.74
Specify TB-size-x,TB-size-y: 16 16
grid dimesion 128 64
<BX=16,BY=16>: Trial 0: GFLOPS: 41.54
<BX=16,BY=16>: Trial 1: GFLOPS: 41.54
<BX=16,BY=16>: Trial 2: GFLOPS: 41.54
<BX=16,BY=16>: Trial 3: GFLOPS: 41.54
<BX=16,BY=16>: Trial 4: GFLOPS: 41.54
Specify TB-size-x,TB-size-y: 32 32
grid dimesion 64 32
<BX=32,BY=32>: Trial 0: GFLOPS: 41.34
<BX=32,BY=32>: Trial 1: GFLOPS: 41.34
<BX=32,BY=32>: Trial 2: GFLOPS: 41.34
<BX=32,BY=32>: Trial 3: GFLOPS: 41.34
<BX=32,BY=32>: Trial 4: GFLOPS: 41.34
*/
int main(){
