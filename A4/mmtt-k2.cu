...
// Enter GPU kernel code body
  ...
  if((row<ds)&&(col<ds)){
    ...
    for(int k=0;k<ds;k+=2){
      //C[i][j] += A[k][i]*B[j][k];
      C[row*ds+col] += A[k*ds+row]*B[col*ds+k];
      C[row*ds+col] += A[(k+1)*ds+row]*B[col*ds+k+1];
    }
  }
}
/*
...
<BX=8,BY=8>: Trial 0: GFLOPS: 50.64
<BX=8,BY=8>: Trial 1: GFLOPS: 74.13
<BX=8,BY=8>: Trial 2: GFLOPS: 74.21
<BX=8,BY=8>: Trial 3: GFLOPS: 74.08
<BX=8,BY=8>: Trial 4: GFLOPS: 73.43
Specify TB-size-x,TB-size-y: 16 16
<BX=16,BY=16>: Trial 0: GFLOPS: 36.05
<BX=16,BY=16>: Trial 1: GFLOPS: 48.58
<BX=16,BY=16>: Trial 2: GFLOPS: 48.18
<BX=16,BY=16>: Trial 3: GFLOPS: 48.36
<BX=16,BY=16>: Trial 4: GFLOPS: 48.32
Specify TB-size-x,TB-size-y: 32 32
<BX=32,BY=32>: Trial 0: GFLOPS: 23.17
<BX=32,BY=32>: Trial 1: GFLOPS: 29.05
<BX=32,BY=32>: Trial 2: GFLOPS: 29.11
<BX=32,BY=32>: Trial 3: GFLOPS: 29.02
<BX=32,BY=32>: Trial 4: GFLOPS: 29.09
*/
int main(){
