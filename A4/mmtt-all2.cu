...
grid dimesion 128 128
<BX=8,BY=8>: Trial 0: GFLOPS: 83.02
<BX=8,BY=8>: Trial 1: GFLOPS: 83.02
<BX=8,BY=8>: Trial 2: GFLOPS: 83.01
<BX=8,BY=8>: Trial 3: GFLOPS: 83.02
<BX=8,BY=8>: Trial 4: GFLOPS: 83.02
Specify TB-size-x,TB-size-y: 16 16
grid dimesion 64 64
<BX=16,BY=16>: Trial 0: GFLOPS: 44.00
<BX=16,BY=16>: Trial 1: GFLOPS: 44.00
<BX=16,BY=16>: Trial 2: GFLOPS: 44.00
<BX=16,BY=16>: Trial 3: GFLOPS: 44.00
<BX=16,BY=16>: Trial 4: GFLOPS: 44.00
Specify TB-size-x,TB-size-y: 32 32
grid dimesion 32 32
<BX=32,BY=32>: Trial 0: GFLOPS: 43.20
<BX=32,BY=32>: Trial 1: GFLOPS: 43.19
<BX=32,BY=32>: Trial 2: GFLOPS: 43.19
<BX=32,BY=32>: Trial 3: GFLOPS: 43.20
<BX=32,BY=32>: Trial 4: GFLOPS: 43.19
*/
int main(){
