// Use "gcc -O3 -fopenmp trimm_main.c trimm_ijk_seq.c trimm_ijk_par.c " to compile for the ijk form
// Use "gcc -O3 -fopenmp trimm_main.c trimm_kij_seq.c trimm_kij_par.c " to compile for the kij form
...
int main(int argc, char *argv[]){
  ...
  for (nt=0;nt<num_cases;nt ++)
  {
   ...
   for (trial=0;trial<NTrials;trial++)
   {
    ...
    tstart = omp_get_wtime();
    trimm_par(N, &a[0][0], &b[0][0], &cc[0][0]);
    telapsed = omp_get_wtime()-tstart;
